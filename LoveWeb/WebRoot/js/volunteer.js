...
function addVActUI(){
	...
	$.post("../servlet/VolunteerUIServlet",
			function(data){
...
function addVActivity(){
	var options = {
            url:'/LoveWeb/servlet/addVActivityServlet', 
            type:'POST',
            dataType:'script',
...
function nowCarry(){
	...
	$.post("../servlet/VActivityServlet?method=nowCarry",
			function(data){
			document.getElementById("right").innerHTML = data;
...
//曾经进行的活动
function oldCarry(){
	$.post("../servlet/OldVActivityServlet",
			function(data){
			document.getElementById("right").innerHTML = data;
...
function joinact(id){
	...
	var json = {id:id};
	$.post("../servlet/JoinVActServlet",json,
			function(data){
				if(data=="unlogin"){
					loginshow();
				}
...
/*
 * jQuery Form Plugin version: 2.21 (08-FEB-2009) @requires jQuery v1.2.2 or
 * later
 * 
        ...
        function cb() {
            ...
            try {
                ...
                if ((doc.body == null || doc.body.innerHTML == '') && !nullCheckFlag) {
                    // in some browsers (cough, Opera 9.2.x) the iframe DOM is
