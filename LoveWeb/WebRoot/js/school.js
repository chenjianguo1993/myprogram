//发起活动页面
function addActUI(method){
	
	$.post("../servlet/SchoolUIServlet?method="+method,
			function(data){
...
function addActivity(){
	var options = {
            url:'/LoveWeb/servlet/addActivityServlet', 
            type:'POST',
            dataType:'script',
...
// 正在进行的活动
function nowCarry(method){
	
	$.post("../servlet/ActivityServlet?method="+method,
			function(data){
			document.getElementById("right").innerHTML = data;
...
//曾经进行的活动
function oldCarry(){
	$.post("../servlet/OldActivityServlet",
			function(data){
			document.getElementById("right").innerHTML = data;
