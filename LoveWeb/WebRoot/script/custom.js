...
$(function () {
	function h() {
		...
		var c = $(window).width(), d = document.getElementById("index_list_round") ? $(".listbox").length + 1 : $(".listbox").length, f = 300, e = 20;
		$.fn.hMR = function () {
			$(this).css({marginRight:e});
		};
		$.fn.nMR = function () {
		...
		(function () {
			for (i = 1; i <= d / ueI; i++) {
				...
				$(".listbox").eq(a).css({marginRight:"0"});
			}
		})();
	}
	function l(a) {
		1 == a && $(".ogrid .nav ul").css({left:-440, width:"auto"});
		0 == a && ($("#maskblack").remove(), $("body").unbind("touchmove"));
	}
	function n() {
		$(".nav ul").animate({left:-440}, 300, "easeOutCubic");
	...
	function p() {
		d && (d = !1, $(".activect").animate({top:-50}, 900, "easeInOutBack", function () {
	...
	function q(a) {
		e && (e = !1, 1 != a ? (c == m - 1 ? c = 0 : c++, $(".index_list_content li:last").clone().prependTo(".index_list_content"), $(".index_list_info").animate({bottom:-70}, 200, "easeOutQuart", function () {
			$(".index_list_info .pd10").hide();
			$(".index_list_info .pd10").eq(c).show();
			$(".index_list_content li:last").animate({width:0}, 1000, "easeOutQuart", function () {
				$(".index_list_content li:last").remove();
				c && $(".index_list_info").animate({bottom:0}, 300, "easeOutQuart");
				e = !0;
			});
		})) : (0 == c ? c = m - 1 : c--, $(".index_list_content li:first").css("width", 0).clone().appendTo(".index_list_content"), $(".index_list_content li:first").remove(), $(".index_list_info").animate({bottom:-70}, 200, "easeOutQuart", function () {
			$(".index_list_info .pd10").hide();
			$(".index_list_info .pd10").eq(c).show();
			$(".index_list_content li:last").animate({width:580}, 1000, "easeOutQuart", function () {
				c && $(".index_list_info").animate({bottom:0}, 300, "easeOutQuart");
				e = !0;
			});
		})));
	...
	function r() {
		f && (f = !1, $(".index_notice_li").animate({top:-40}, 900, "easeInOutBack", function () {
	...
	$.fn.forRetina = function (a, b, c) {
		1 == a ? $(this).css({backgroundImage:"url(" + b + ")", backgroundSize:"" + c + ""}) : $(this).attr("style", "");
	};
	...
	document.getElementById("switchresult") && 880 <= $(".common").width() && ($(".selected").each(function () {
		var a = $(this).find(".acate").html(), a = $("<li><a href=\"javacript:;\">" + a + "</a><a class=\"closetag\" href=\"javascript:return false;\"></a></li>");
	...
	$(".ogrid .navlist").bind("touchstart", function () {
		if (-440 == parseInt($(".nav ul").css("left"), 10)) {
			...
			$(".nav ul").css({width:a});
			$(".nav ul").animate({left:0}, 300, "easeOutCubic");
	...
	$(".cate4 li").each(function () {
		...
		$(this).find("a").css({backgroundPosition:"" + a + "px 5px"});
	});
	3 >= $(".searchtags li").length && $(".cates li").click(function () {
		var a = $(".searchtags ul").html(), b = $(this).find(".acate").html(), c = $(this).find(".sca").html();
	...
	$(".cate ul li").mouseover(function () {
		var a = $(this).index(), b = 40 * a + 21, c = 80 * (a - 1);
		0 != a && (sfaddsf = setTimeout(function () {
			$("#catemove").fadeIn(200);
			$(".catedecoration").animate({left:b}, 200, "easeOutQuart");
			$(".catedecorationtext").animate({left:b}, 200, "easeOutQuart");
			$(".catedecorationtext .tul").animate({marginLeft:-c}, 500, "easeOutQuart");
		}, 250));
	}).mouseleave(function () {
	...
	$.fn.showSlide = function () {
		$(this).hover(function () {
			...
			dsfdjsk = setTimeout(function () {
				a.find(".sc_detail").stop(!0, !1).animate({bottom:"0"}, 450, "easeOutQuart");
			}, 50);
		}, function () {
			clearTimeout(dsfdjsk);
			$(this).find(".sc_detail").stop(!0, !1).animate({bottom:"-60px"}, 380, "easeOutQuart");
		});
	};
	$(".newlist").showSlide();
	$(".colorsmall li").hover(function () {
		$(".colorsmall li a").css({"z-index":0});
		0 > $(this).attr("class").indexOf("white") ? ($(this).css({"z-index":2}), $(this).find("a").css({"z-index":3}).stop(!0, !1).animate({width:"31px", height:"12px", left:"-3px", top:"-3px"}, 80, "easeOutQuart")) : $(this).find("a").css({"z-index":3}).stop(!0, !1).animate({width:"29px", height:"10px", left:"-3px", top:"-3px"}, 80, "easeOutQuart");
	}, function () {
		$(".colorsmall li").css({"z-index":0});
		$(".colorsmall li a").css({"z-index":0});
		0 > $(this).attr("class").indexOf("white") ? $(this).find("a").stop(!0, !1).animate({width:"25px", height:"6px", left:"0", top:"0"}, 150, "easeOutQuart") : $(this).find("a").stop(!0, !1).animate({width:"23px", height:"4px", left:"0", top:"0"}, 150, "easeOutQuart");
	});
	$(".boxtags").each(function () {
		$(this).find("li").eq(0).css({paddingLeft:"0", background:"none"});
	});
	...
	$(".openlogin").click(function () {
		...
		k && "0px" != $("#loginalert").css("top") && ($("#loginalert").show(), $(".loginmask").fadeIn(500), $("#loginalert").animate({top:100}, 400, "easeOutQuart"));
	});
	...
	$("#fswitch li").mouseover(function () {
		...
		$(".fswitcharrow").stop(!0, !1).animate({left:a}, 260, "easeOutQuart");
	});
	$("#fswitch ul").mouseleave(function () {
		var a = 140 * s;
		$(".fswitcharrow").stop(!0, !1).animate({left:a}, 260, "easeOutQuart");
	});
	$(".fswitcharrow").css({left:140 * s}, 260, "easeOutQuart");
	...
	$(window).scroll(function () {
		0 < $(window).scrollTop() ? ($("#backtop").css({bottom:10}), $("#backtop").click(function () {
			if (!$("html,body").is(":animated")) {
				return $("html,body").animate({scrollTop:0}, 500), !1;
			}
		})) : $("#backtop").css({bottom:-40});
	});
	$(".nsmall:last").css({marginBottom:0});
	$(".activeprev").click(function () {
		d && (d = !1, $(".activect li:last").clone().prependTo(".activect"), $(".activect").css("top", -50), $(".activect").animate({top:0}, 900, "easeInOutBack", function () {
	...
	$(".newlist .likeit,.morewebsite .likeit,.nsmall .likeit").click(function () {
		...
		var a = $(this).attr("data-postid"), b = $(this), c = parseInt($(this).find("a").html(), 10);
		0 > b.attr("class").indexOf("dontlikeit") ? (b.addClass("loading"), 0 < b.attr("class").indexOf("loading") && b.loading("loading.gif"), YYService.call("addLike", {complete:function () {
			b.attr("style", "");
			...
			alert("\u60a8\u6162\u70b9\u70b9");
		}}, {postid:a})) : YYService.call("removeLike", {complete:function () {
	...
	$("#addlike").click(function () {
		...
		var a = $(this);
		$(this).hasClass("active") ? YYService.call("removeLike", {complete:function () {
			a.removeClass("active");
			$("span", a).html(parseInt($("span", a).html()) - 1);
			$("#user_active").remove();
		}, error:function () {
			alert("\u60a8\u6162\u70b9\u70b9");
		}}, {postid:$(this).attr("data-postid")}) : YYService.call("addLike", {complete:function () {
			a.addClass("active");
			$("span", a).html(parseInt($("span", a).html()) + 1);
	...
	$(".addfavorite").click(function () {
		...
		var a = $(this).attr("data-postid"), b = $(this), c = $(this).find(".like_i"), d = parseInt($(this).find(".like_i").html());
		b.hasClass("addfavorite_l") ? YYService.call("removeLike", {complete:function () {
			b.removeClass("addfavorite_l");
			c.html(d - 1);
			$("#user_active").remove();
		}, error:function () {
			alert("\u60a8\u6162\u70b9\u70b9");
		}}, {postid:a}) : YYService.call("addLike", {complete:function () {
	...
	var e = !0, m = $(".index_list_content li").length, c = 0;
	...
	$("#index_list_round").hover(function () {
		...
		$(".index_list_info").stop(!0, !0).animate({bottom:0}, 300, "easeOutQuart", function () {
			$(".index_list_arrow_prev").addClass("index_list_cur");
			$(".index_list_arrow_next").addClass("index_list_cur");
		});
	}, function () {
		$(".index_list_info").stop(!0, !0).animate({bottom:-70}, 300, "easeOutQuart", function () {
	...
	$(".index_notice_prev").click(function () {
		f && (f = !1, $(".index_notice_li li:last").clone().prependTo(".index_notice_li"), $(".index_notice_li").css("top", -40), $(".index_notice_li").animate({top:0}, 900, "easeInOutBack", function () {
	...
	$("#index_notice").hover(function () {
		...
		fdsafdasdasf = setInterval(r, 5000);
	}).trigger("mouseleave");
	$.fn.placeholder = function () {
		var a = $(this), b = a.attr("value");
		a.focus(function () {
	...
	$("#sort dl").hover(function () {
		var a = $("#sort dd").length, b = $("#sort dd").height();
		$("#sort dl").stop(!0, !0).animate({height:(a + 1) * b}, 500, "easeOutCubic");
		$("#sort dt i").addClass("rotatei");
	}, function () {
		$("#sort dl").stop(!0, !0).animate({height:$("#sort dd").height()}, 500, "easeOutCubic");
	...
	$("#postbtn.sitemessage").click(function (a) {
		...
		YYService.call("siteMessage", {complete:function () {
