...
<html>
  ...
  <body>
		<div id="content1">
                  ...
                  <div id="list">
                  		<form id="addAct" method="post" onsubmit="return addActivity()" enctype="multipart/form-data">
                    	<table style="margin-left:20px;">
                                ...
                                <tr>
									<td class="left">标题图片：</td>
									<td>
										<input type="file" name="file" size=60 />
									</td>	
								</tr>
								<tr>
									<td class="left">宣传视频：</td>
									<td>
										<input type="file" name="video" size=60 />
									</td>	
								</tr>
                                <tr>
                                	<td class="left">活动时间：</td>
                                    <td>
		   								<input id="startdate" type="text" name="startdate" value="" onClick="WdatePicker()"/>至<br/>
	    	  							<input id="enddate" type="text" name="enddate" onClick="WdatePicker()"/>
	    	  						</td>
                                    
                                </tr>
                                <tr>
									<td class="left">活动地点：</td>
									<td>
