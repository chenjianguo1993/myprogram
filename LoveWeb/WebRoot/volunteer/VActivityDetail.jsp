...
<html>
	<head>
		<title>志愿者-详细活动</title>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-1.7.2.min.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/nav.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/volunteer.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/VActivityDetail.js"></script>
				...
				<div id="left">
                    ...
                    <div class="list">
                        <div class="list_title">
                        	<div class="list_top"><span>志愿者募集</span></div>
                        	<div class="list_button"><span>55个人关注　　24个评论</span></div>
                        </div>
                         <div class="list_title">
                        	<div class="list_top"><span>看望老人院</span></div>
                        	<div class="list_button"><span>35个人关注　　35个评论</span></div>
                        </div>
                         <div class="list_title">
                        	<div class="list_top"><span>看望孤儿院</span></div>
                        	<div class="list_button"><span>32个人关注　　24个评论</span></div>
                        </div>
                         <div class="list_title">
                        	<div class="list_top"><span>志愿者募集</span></div>
                        	<div class="list_button"><span>25个人关注　　14个评论</span></div>
                        </div>
                	</div>
                </div>
                <div id="right">
                	<div id="video_box">
	                    ...
	                    <div class="count"><span id="${actuser.activityid }" onclick="return joinactivity('${actuser.activityid}')">报名(${actuser.joinnum })&nbsp;&nbsp;</span><span>
