  ...
  <body>
    ...
    <div class="activity">
        ...
        <div class="activity_content_left">
				<div class="activity_content_left_img"><img src="${pageContext.request.contextPath }/image/${newactivity.image }"></div>
        ...
        <div class="activity_content_right">
               <div class="right_button" style="margin-top:120px;"><span><a href="${pageContext.request.contextPath }/servlet/DetailVActivityServlet?activityid=${newactivity.activityid }">查看详细</a></span></div>
                      <c:choose>
      ...
      <div class="activity" style="margin-top:20px;">
           <div class="title">
			...
			<c:forEach var="popactivity" items="${pop2list}">  
              <div class="activity_content_left">
						<div class="activity_content_left_img"><img src="${pageContext.request.contextPath }/image/${popactivity.image }"></div>
							<div class="activity_content_left_content">
								<div class="aclc_top">
							<div class="activity_title">
								<span>标题:
