...
public class OldActivityServlet extends HttpServlet
{
			...
			throws ServletException, IOException
	{
		...
		}else
		{
			...
			request.getRequestDispatcher("/school/oldCarryActivity.jsp").forward(request, response);
		}
